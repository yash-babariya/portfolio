  ...
  return (
    <div>
      ...
      <style>
		...
		#cursor {
			position: absolute;
			background-color: ${isClicking ? 'var(--theme-sky-blue-background-color)' : 'var(--theme-sky-blue-background-color)'};
			height: 10px;
			width: 10px;
			border-radius: 50%;
    ...
    @media (max-width:768px) {
		...
		#cursor-border {
			...
			border: 3px solid ${buttonHovered ? 'var(--theme-sky-blue-background-color)' : 'var(--theme-dark-backgroud-color)'};
			border-radius: 50%;
			transform: translate(-50%, -50%);
			pointer-events: none;
